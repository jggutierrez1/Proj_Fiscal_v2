...
begin
  ...
  begin
    ...
    cPorc1 := utiles.FloatToStr2(utiles.RoundD((ProgressBar1.Position / ProgressBar1.Max) * 100, 0)) + ' %';
  ...
  begin
    ...
    if self.oCPorc2.Visible = false then
      ...
      if self.Height <> 133 then
        self.Height := 133;
    cPorc2 := FloatToStr2(RoundD((ProgressBar2.Position / ProgressBar2.Max) * 100, 0)) + ' %';
